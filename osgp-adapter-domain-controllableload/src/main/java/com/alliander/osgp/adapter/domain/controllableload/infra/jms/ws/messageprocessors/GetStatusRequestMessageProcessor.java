...
/**
 * Class for processing controllable load get status request messages
 */
@Component("domainControllableLoadGetStatusRequestMessageProcessor")
public class GetStatusRequestMessageProcessor extends WebServiceRequestMessageProcessor {
    /**
     * Logger for this class
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(GetStatusRequestMessageProcessor.class);
