 ...
 */
package com.alliander.osgp.adapter.domain.controllableload.infra.jms.ws;
...
@Component(value = "domainControllableLoadIncomingWebServiceRequestMessageListener")
public class WebServiceRequestMessageListener implements MessageListener {
    ...
    @Autowired
    @Qualifier("domainControllableLoadWebServiceRequestMessageProcessorMap")
