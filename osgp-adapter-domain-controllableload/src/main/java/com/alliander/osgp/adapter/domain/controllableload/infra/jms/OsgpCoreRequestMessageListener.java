 ...
 */
package com.alliander.osgp.adapter.domain.controllableload.infra.jms;
...
@Component(value = "domainControllableLoadIncomingOsgpCoreRequestMessageListener")
public class OsgpCoreRequestMessageListener implements MessageListener {
    ...
    @Autowired
    @Qualifier(value = "domainControllableLoadIncomingOsgpCoreRequestMessageProcessor")
