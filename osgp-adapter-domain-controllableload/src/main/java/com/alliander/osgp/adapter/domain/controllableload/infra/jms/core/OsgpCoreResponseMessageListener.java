 ...
 */
package com.alliander.osgp.adapter.domain.controllableload.infra.jms.core;
...
@Component(value = "domainControllableLoadIncomingOsgpCoreResponseMessageListener")
public class OsgpCoreResponseMessageListener implements MessageListener {
    ...
    @Autowired
    @Qualifier("domainControllableLoadOsgpCoreResponseMessageProcessorMap")
